...
values
  ...
  ('completions-fifteen', 'Fifteen Strong', 'Complete fifteen missions.', 100, 'total_completions', 15),
  ('quarter-century', 'Quarter Century', 'Complete twenty-five missions.', 150, 'total_completions', 25),
  ('half-century', 'Half Century', 'Complete fifty missions.', 250, 'total_completions', 50),
  ('centurion', 'Centurion', 'Complete one hundred missions.', 500, 'total_completions', 100),
  ('double-century', 'Double Century', 'Complete two hundred missions.', 750, 'total_completions', 200),
  ('mission-master', 'Mission Master', 'Complete five hundred missions.', 1500, 'total_completions', 500),
  ('streak-five', 'Five Alive', 'Log wins five days in a row.', 150, 'current_streak', 5),
  ('week-warrior', 'Week Warrior', 'Log wins seven days in a row.', 200, 'current_streak', 7),
  ('fortnight-focus', 'Fortnight Focus', 'Log wins fourteen days in a row.', 350, 'current_streak', 14),
  ('streak-twenty-one', 'Habit Formed', 'Log wins twenty-one days in a row.', 500, 'current_streak', 21),
  ('monthly-momentum', 'Monthly Momentum', 'Log wins thirty days in a row.', 600, 'current_streak', 30),
  ('unbroken-fifty', 'Unbroken', 'Log wins fifty days in a row.', 1000, 'current_streak', 50),
  ('centennial-streak', 'Centennial Streak', 'Log wins one hundred days in a row.', 2000, 'current_streak', 100),
  ('first-critical', 'Under Pressure', 'Complete your first critical mission.', 50, 'critical_completed', 1),
  ('critical-ten', 'Crisis Manager', 'Complete ten critical missions.', 200, 'critical_completed', 10),
  ('critical-twenty-five', 'Firefighter', 'Complete twenty-five critical missions.', 400, 'critical_completed', 25),
  ('critical-fifty', 'High-Stakes Veteran', 'Complete fifty critical missions.', 750, 'critical_completed', 50),
  ('critical-hundred', 'Pressure Cooker', 'Complete one hundred critical missions.', 1500, 'critical_completed', 100),
  ('critical-five-hundred', 'Crisis Legend', 'Complete five hundred critical missions.', 3000, 'critical_completed', 500),
  ('xp-500', 'Getting Started', 'Earn 500 XP.', 75, 'total_xp', 500),
  ('xp-2500', 'XP Collector', 'Earn 2,500 XP.', 250, 'total_xp', 2500),
  ('xp-5000', 'XP Hoarder', 'Earn 5,000 XP.', 500, 'total_xp', 5000),
  ('xp-10000', 'Five Figures', 'Earn 10,000 XP.', 1000, 'total_xp', 10000),
  ('xp-25000', 'XP Magnate', 'Earn 25,000 XP.', 2500, 'total_xp', 25000),
  ('xp-50000', 'Legendary Grind', 'Earn 50,000 XP.', 5000, 'total_xp', 50000);
